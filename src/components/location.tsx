...
export const LocationShow = () => (
    <Show title={<LocationTitle/>}>
        <SimpleShowLayout>
            ...
            <FunctionField label="Kategoria"
                           render={(record: { category: string }) => `${CATEGORIES[record.category]}`}/>
    ...
    (
        <Edit title={<LocationTitle/>}>
            <SimpleForm>
                ...
                <SelectInput label="Kategoria" source="category" name="category" choices={CATEGORIES_LIST}/>
                ...
                <TextInput label="Godziny otwarcia" source="opening_hours" name="opening_hours"/>
                <TextInput label="Numer telefonu" source="phone_number" name="phone_number"/>
